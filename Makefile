...
CFLAGS	+=	-DPES_LOOSE_CPK_FULL=$(PES_LOOSE_CPK_FULL)
...
# Only runtime blobs belong in bin2o. JSON files under data/ are generator
# metadata and must not be linked into the NRO.
