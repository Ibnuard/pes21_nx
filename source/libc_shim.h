...
#define FAKE_URANDOM_FD 0x70010000
...
const void *AAsset_getBuffer_fake(void *a);
int AAsset_openFileDescriptor_fake(void *a, long *start, long *length);
int AAsset_openFileDescriptor64_fake(void *a, int64_t *start, int64_t *length);
